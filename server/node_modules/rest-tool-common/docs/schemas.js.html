      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="schemas.js.html">schemas.js</a></li>
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              ...
              <li><a href="#loadSchema"><i class="alert alert-info"></i>loadSchema</a>
              </li>
              <li><a href="#validate"><i class="alert alert-info"></i>validate</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          ...
          <div class="description"><p>JSON schema validator for the restapi tool</p> </div>
...
var js = new JaySchema();</code></pre>
          <section id="loadSchema">
            <h1>loadSchema</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>loadSchema()</span> -><span>Object</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>String</td>
                <td>The name of the schema file</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>Load the named JSON schema</p> </div>
          <pre><code class="language-javascript">var loadSchema = function(fullSchemaFileName) {
    ...
    return mainSchema;
          ...
          <section id="validate">
            ...
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">method</div><span>exports.validate()</span> -><span>Array</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            <thead>
          ...
          <div class="description"><p>Validate the 'content' object with the JSON schema from 'schemaFileName' file</p> </div>
          <pre><code class="language-javascript">exports.validate = function(content, schemaFileName) {
