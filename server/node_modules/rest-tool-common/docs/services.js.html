      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class=""><a href="generator.js.html">generator.js</a></li>
            <li class=""><a href="schemas.js.html">schemas.js</a></li>
            <li class="active"><a href="services.js.html">services.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#fs"><i class="alert alert-success"></i>fs</a>
              </li>
              <li><a href="#config"><i class="alert alert-success"></i>config</a>
              </li>
              <li><a href="#services"><i class="alert alert-success"></i>services</a>
              </li>
              <li><a href="#loadFile"><i class="alert alert-info"></i>loadFile</a>
              </li>
              <li><a href="#getMockResponseBody"><i class="alert alert-info"></i>getMockResponseBody</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          ...
          <section id="fs">
            ...
            <p>
              <div class="label label-success radius ctx-type">declaration</div><span>fs</span>
            </p>
          </section>
          <div class="description"><p>Service Loader for the restapi tool</p> </div>
          <pre><code class="language-javascript">var fs = require('fs');

var schemas = require('./schemas.js');</code></pre>
          <section id="config">
            <h1>config</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-success radius ctx-type">declaration</div><span>config</span>
            </p>
          </section>
          <div class="description"><p>restapi configuration parameters</p> </div>
          <pre><code class="language-javascript">var config = {};</code></pre>
          <section id="services">
            <h1>services</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-success radius ctx-type">declaration</div><span>services</span>
            </p>
          </section>
          <div class="description"><p>Descriptors of all services</p> </div>
          <pre><code class="language-javascript">var services = {};</code></pre>
          <section id="loadFile">
            <h1>loadFile</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>loadFile()</span> -><span>Buffer</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>String</td>
                <td>The path to the content file</td>
              </tr>
              <tr>
                <td>encoding</td>
                <td>String</td>
                <td>The encoding of the content file</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>Load content identified by 'contentFileName' with the selected 'encoding'</p> </div>
          <pre><code class="language-javascript">var loadFile = function (contentFileName, encoding) {
    var fs = require('fs');
...
var findHeaderValue = function ( headers, field ) {
    ...
    return content;
          ...
          <section id="getMockResponseBody">
            <h1>getMockResponseBody</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">method</div><span>exports.getMockResponseBody()</span> -><span>String</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            <thead>
            ...
            <tbody>
              ...
              <tr>
                <td>serviceDesc</td>
                <td>Object</td>
                <td>The service descriptor</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>Get the response body of a given method of a service.<br />The default content type is 'application/json'.</p> </div>
          <pre><code class="language-javascript">exports.getMockResponseBody = function(method, serviceDesc) {
