    ...
    <div class="container">
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#extend"><i class="alert alert-success"></i>extend</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="extend">
            ...
            <p>
              <div class="label label-success radius ctx-type">property</div><span>exports.extend</span>
            </p>
          </section>
          <div class="description"> </div>
          <pre><code class="language-javascript">exports.extend = require('./extend');
exports.generator = require('./generator');
exports.services = require('./services');</code></pre>
        </div>
      </div>
    </div>
    <footer class="footer">
